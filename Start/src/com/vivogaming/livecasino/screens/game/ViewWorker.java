...
import static com.vivogaming.livecasino.screens.game.WinnerWorker.restoreWinnerBox;
import static com.vivogaming.livecasino.screens.game.WinnerWorker.findWinnerViews;;
...
public abstract class ViewWorker {
    ...
    public static final void showWinner(final String _resultSum, final String _amount,
        ...
        Log.i("result", "get resultSam from server");
        Log.i("result", "_resultSum="+ _resultSum +" ; _amount="+ _amount);
         ...
         */
        restoreWinnerBox();
        findWinnerViews(_rlRoot_SG, Integer.valueOf(_resultSum));
        showWinnerBoxToastWithDelay(getGameActivity(), getWinnerString(_resultSum, _amount), _rlRoot_SG, _tvBetCount_SG, _amount);
