...
public abstract class ChipsPlacing {
    ...
    public static final void hideAndMoveBetZone(final Activity _activity){
    	 ...
    	 * 2014 年 4月3日
         */
        root.findViewById(R.id.ivBankerPair_TXET).setVisibility(View.INVISIBLE);
        root.findViewById(R.id.ivPlayerPair_TXET).setVisibility(View.INVISIBLE);
        /**
    	 * developer Sam
    	 * 2014 年 3月29日
    ...
    public static final int dd(){
    	return getImageIdByChipValue(5);
    }
